...
SalorRetail::Application.configure do
  ...
  config.assets.precompile += ["customer_screen.sass","dropzone.css","generic.sass","home.sass","invoice_default.sass","invoice_default_print.sass","invoice-print.sass","mobile.sass","print.sass","receipts.sass","shipments.sass","scaffolds.css.sass","timepicker.css","ui-min.css","workstation.sass"]
